...
Project 1 explores cubic splines and the deBoor algorithm. Above are some sample images created by the program. The right is a cubic spline and the left its basis functions visualized. Please take a look at the pdf file in each folder for a full outline of the project.


 for a full outline of the project.
...
Project 2 covers multivariate optimization methods such as the Newton method and quasi Newton methods such as BFGS and DFP.Please take a look at the pdf file for a full outline of the project.
