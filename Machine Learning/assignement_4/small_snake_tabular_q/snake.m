...
rewards = struct('default', 0, 'apple', 5, 'death', -10); % Reward signal
gamm    = 0.99;  % Discount factor in Q-learning
alph    = 0.6; % Learning rate in Q-learning (automatically set to zero during testing)
eps     = 1e-3; % Random action selection probability in epsilon-greedy Q-learning (automatically set to zero during testing)
...
for i = 1 : nbr_ep
    ...
    while 1
        ...
        if terminate
            ...
            sample                    = reward; % No future rewards.
