...
class OptimizationProblem:
    ...
    def __init__(self, func, gradient = None):
        ...
        ----------
        func : function
            function with one argument of arbitrary dimension :)
        gradient : function, optional
            gradient of func. The default is None.
...
if __name__ == '__main__':
    ...
    # hes_problem = OptimizationProblem(sphere)
    # result6 = Results(hes_problem, name = "Hessian diff")
    # result6.hessian_diff_2()
    
    problem2 = OptimizationProblem(cqp.chebyquad)
    result2 = Results(problem2, name = "Chebyquad", methods = [BFGS(True)])
    result2.show_plots_and_tables(num_points=11)
